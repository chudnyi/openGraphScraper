...
module.exports = function (options, callback) {
    exports.getInfo(options, function (err, results, context) {
        callback(err, results, context);
    });
};
...
exports.getInfo = function (options, callback) {
    ...
    this.validateVars(options.url, options.timeout, function (inputUrl, inputTimeout) {
        if (inputUrl) {
            ...
            that.getOG(options, function (err, results, context) {
                if (results) {
                    returnResult = {
                        data: results,
                        success: true
                ...
                callback(error, returnResult, context);
            });
        } else {
            callback(true, {
                success: false,
